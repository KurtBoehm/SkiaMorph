...
// https://github.com/google/skia/blob/chrome/m147/modules/svg/include/SkSVGDOM.h,
...
#ifndef SRC_SVG_DOM_HPP
#define SRC_SVG_DOM_HPP
...
public:
  ...
  static sk_sp<SVGDOM> MakeFromStream(SkStream& str);
...
private:
  SVGDOM(sk_sp<SkSVGSVG>, sk_sp<SkFontMgr>, sk_sp<skresources::ResourceProvider>, SkSVGIDMapper&&,
